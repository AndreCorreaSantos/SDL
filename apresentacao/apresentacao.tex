...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{exemplo_codigo.png}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.25]{imgs/neural_network_2.png}
    %\newline Fonte: \emph{Spinning-up in RL} (spinningup.openai.com)
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.25]{imgs/code_3.png}
    %\newline Fonte: \emph{Spinning-up in RL} (spinningup.openai.com)
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.22]{imgs/neural_network_3.png}
    %\newline Fonte: \emph{Spinning-up in RL} (spinningup.openai.com)
\end{figure}
